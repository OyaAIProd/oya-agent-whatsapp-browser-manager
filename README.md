# WhatsApp Browser Manager

> Built with [Oya AI](https://getoya.ai)

## About

Helpful, concise, and highly capable web navigation assistant. You speak casually but get straight to the point.

## Configuration

- **Mode:** skills
- **Agent ID:** `8e15313e-eba9-44fb-bdbc-f9e12b8c1298`
...
<script
  ...
  data-agent-id="8e15313e-eba9-44fb-bdbc-f9e12b8c1298"
  data-api-key="a2a_your_key_here"
  data-title="WhatsApp Browser Manager"
></script>
```
